...
**Tech Stack:** `Python` · `LangChain` · `ChromaDB` · `RAG` · `Vector Search`

- 📄 Processed and indexed **500+ pages** of PDF documents into **1,000+ semantic chunks** using LangChain and ChromaDB for document retrieval
- ⚡ Reduced manual document search time by **80%** using vector-based semantic search and Retrieval-Augmented Generation (RAG)
...
[![GitHub](https://img.shields.io/badge/GitHub-View_Code-181717?style=flat-square&logo=github)](https://github.com/AYUSHGUPTA9506)

---

### 🎥 VideoMind — AI Meeting Intelligence Platform
**Tech Stack:** `Python` · `NLP` · `RAG Architecture` · `Transcription` · `Summarization`

- 🎙️ Automated transcription and summarization of **60+ minute** meeting recordings, reducing note-taking effort by **90%**
- 📊 Built an NLP pipeline that extracted **150+ actionable insights** from team meetings monthly, cutting follow-up inquiries by **40%**
...
**Tech Stack:** `Python` · `LangChain` · `LLMs` · `Web Scraping` · `Agentic AI`
...
- ✅ Implemented a self-correction loop via the Critic agent — improving factual accuracy to **95%** and reducing output errors by **40%**
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=AYUSHGUPTA9506&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true)

![GitHub Streak](https://streak-stats.demolab.com/?user=AYUSHGUPTA9506&theme=tokyonight&hide_border=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=AYUSHGUPTA9506&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true&layout=compact)
